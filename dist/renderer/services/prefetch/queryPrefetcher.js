...
class QueryPrefetcher {
    ...
    async prefetchEmbedding(query) {
        try {
            ...
            const embedding = await invoke('embed_text', {
                text: query,
...
// Singleton instance
let prefetcherInstance = null;
export function getQueryPrefetcher() {
