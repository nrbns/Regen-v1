 ...
 */
export async function generateHuggingFaceEmbedding(text, model = DEFAULT_MODEL) {
    try {
 ...
 */
export async function batchGenerateEmbeddings(texts, model = DEFAULT_MODEL) {
    try {
 ...
 */
export async function checkHuggingFaceAvailable() {
    try {
