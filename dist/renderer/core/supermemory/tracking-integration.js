 ...
 */
export async function autoTrackVisit(url, title, tabId) {
    try {
 ...
 */
export async function autoTrackSearch(query, searchEngine, clickedResult) {
    try {
 ...
 */
export async function autoTrackModeSwitch(fromMode, toMode, _reason) {
    try {
