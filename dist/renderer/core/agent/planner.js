 ...
 */
function createResearchComparePlan(goal) {
    const nodes = [
        {
            id: 'search',
            tool: 'search_web',
 ...
 */
function createSummaryPlan(goal) {
    const nodes = [
        {
            id: 'scrape',
            tool: 'scrape_page',
 ...
 */
function createExtractDatesPlan(goal) {
    const nodes = [
        {
            id: 'scrape',
            tool: 'scrape_page',
 ...
 */
export async function executePlanFromGoal(goal) {
