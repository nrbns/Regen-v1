 ...
 */
import { registerReducer } from './event-log';
/**
 * Tab state reducer
 */
export const tabReducer = (state, event) => {
 ...
 */
export const performanceReducer = (state, event) => {
 ...
 * Policy reducer
 */
export const policyReducer = (state, event) => {
    switch (event.type) {
 ...
 */
export const aiOptimizationReducer = (state, event) => {
    switch (event.type) {
 ...
 */
export const resourceReducer = (state, event) => {
 ...
 */
export function registerDefaultReducers() {
