...
async function captureSnapshot() {
    ...
    try {
        ...
        const capacity = typeof navigator !== 'undefined' && 'deviceMemory' in navigator
...
function estimateSavings(samples) {
    if (!samples.length)
        return undefined;
