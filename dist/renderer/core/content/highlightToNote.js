...
export class HighlightToNote {
     ...
     */
    static showFloatingButton(selection, text, _event) {
     ...
     */
    static async createNoteFromSelection(text, selection) {
     ...
     * Show note creation dialog
     */
    static showNoteDialog(selection, url) {
      ...
      `;
            ...
            const noteContent = dialog.querySelector('#regen-note-content');
            const tagsInput = dialog.querySelector('#regen-note-tags');
