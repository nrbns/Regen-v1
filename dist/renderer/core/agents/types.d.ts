...
export type AgentCapability = 'memory:read' | 'memory:write' | 'web:fetch' | 'redix:ask' | 'system:dispatch';
...
export type AgentToolExecutor = (input: Record<string, unknown>, ctx?: Partial<AgentToolContext>) => Promise<unknown>;
