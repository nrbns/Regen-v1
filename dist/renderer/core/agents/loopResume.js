 ...
 */
export function loadAllLoopStates() {
    try {
 ...
 */
export function loadLoopState(runId) {
 ...
 */
export function resumeLoop(runId) {
    try {
 ...
 */
export function deleteLoopState(runId) {
    try {
        const all = loadAllLoopStates();
...
export function startAutoSave(metadata) {
    if (saveInterval) {
 ...
 */
export function checkForCrashedLoops() {
    const all = loadAllLoopStates();
    const now = Date.now();
