...
export function buildSearchUrl(provider, q, language, preferIframeFriendly = true) {
 ...
 */
export function normalizeInputToUrlOrSearch(input, provider = 'google', language, preferIframeFriendly = true) {
