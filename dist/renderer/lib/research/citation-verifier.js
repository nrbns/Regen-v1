 ...
 */
function findCitationTokens(text) {
    const citations = [];
 ...
 */
function sentenceHasCitation(sentence, citations, _text) {
    ...
    const relevantCitations = citations.filter((cit) => cit.index >= sentenceStart && cit.index < searchEnd);
 ...
 */
export function verifyCitationCoverage(summary, _citations) {
 ...
 */
export function verifyCitationsWithSources(summary, citations, totalSources) {
