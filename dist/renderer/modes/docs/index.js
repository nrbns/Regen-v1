...
function IngestForm({ ingestType, ingestUrl, loading, uploadProgress, error, fileToIngest, onTypeChange, onUrlChange, onFileSelect, onSubmit, onCancel, onEdit, onOCR: _onOCR, }) {
