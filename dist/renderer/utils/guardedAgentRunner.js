 ...
 */
export async function guardedRunAgent(tabId, options = {}) {
    ...
    try {
        ...
        if (options.extractText !== false && capturedUrl && !capturedUrl.startsWith('about:')) {
            try {
                ...
                const tabStillExists = currentTabsState.tabs.find((t) => t.id === capturedTabId);
                if (!tabStillExists) {
                ...
                if (typeof window !== 'undefined' && window.__TAURI__) {
                    try {
                        ...
                        pageText = await invoke('extract_page_text', { url: capturedUrl });
 ...
 */
export function cancelAgentRun(tabId) {
 ...
 */
export function cancelAllAgentRuns() {
