...
import { validateCommandName, sanitizeString, sanitizeUrl, validateIpcRequest, } from '../ipc-validator';
describe('IPC Validator', () => {
    ...
    describe('validateIpcRequest', () => {
        ...
        it('should handle nested objects', () => {
            ...
            expect(result.sanitized.config).toHaveProperty('apiUrl', 'https://api.example.com');
        });
    });
});
