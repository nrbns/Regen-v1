 ...
 */
export function extractPageContent(document, url) {
 ...
 */
export async function extractPageContentFromUrl(_url) {
 ...
 */
export function formatForLLM(metadata, includeStructured = true) {
