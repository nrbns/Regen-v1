...
export function ContextOverlay({ title, content, children, onDismiss }: { title?: string; content?: React.ReactNode; children?: React.ReactNode; onDismiss?: () => void }) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      <div className="max-w-lg rounded-lg bg-gray-900 p-6 text-white shadow-lg">
        <div className="flex items-center justify-between">
          ...
          <button onClick={() => onDismiss && onDismiss()} className="text-gray-400">Close</button>
        </div>
