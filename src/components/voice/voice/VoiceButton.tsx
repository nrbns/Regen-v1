// v1 stub: VoiceButton deferred to src/_deferred/voice/VoiceButton.tsx
export default function VoiceButton(_props: any) {
  return null;
}
...
function __removed_VoiceButton_duplicate({ onResult, small, editBeforeExecute = false }: Props) {
