// FloatingAIBar deferred for v1 — original in src/_deferred/pageAI/FloatingAIBar.tsx
export function FloatingAIBar(_props: any) {
  return null;
}
...
function __removed_FloatingAIBar_impl({ selectedText, position, onClose }: FloatingAIBarProps) {
