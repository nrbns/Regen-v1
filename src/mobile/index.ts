...
// Hooks
export { useMobileDetection, detectDeviceType } from './hooks/useMobileDetection';
...
export { mobileRedix, queryRedix, streamRedixQuery, checkRedixHealth, getEcoScore } from './utils/redixClient';
