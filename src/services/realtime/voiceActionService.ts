...
class VoiceActionService {
  ...
  private callbacks: Set<VoiceActionCallback> = new Set();
   ...
   */
  async sendVoiceCommand(text: string, mode?: string): Promise<VoiceAction> {
   ...
   */
  private sendCommand(text: string, mode: string | undefined, requestId: string): void {
  ...
  private scheduleReconnect(): void {
    ...
    console.log(
      `[VoiceActionService] Reconnecting in ${delay}ms (attempt ${this.reconnectAttempts})`
    );
